...
* [Values Representations](the-structure/values/README.md)
  ...
  * [Numeric Values](the-structure/values/number/README.md)
    ...
    * [Special Numeric Integer Formats](the-structure/values/number/special-numeric-integer-formats/README.md)
      * [Hexadecimal](the-structure/values/number/special-numeric-integer-formats/hexadecimal-integer.md)
      * [Octal](the-structure/values/number/special-numeric-integer-formats/octal-integer.md)
      * [Binary](the-structure/values/number/special-numeric-integer-formats/binary-integer.md)
